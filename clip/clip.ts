...
clip.addIncident(widthHeight("236px","148px",".title-wrapper",200,"@stagger(0,200)"),0);
clip.addIncident(widthHeight("511px","286px",".description-container",200),600);
clip.addIncident(widthHeight("218px","218px",".image",200,"@stagger(0,200)"),900);
